// version.hpp: Version reflection information for smoothxg builds.
...
namespace smoothxg {
	...
	class Version {
	public:
		/// The Git version description of this build of smoothxg
		const static string VERSION;

		/// Get only the version (like v1.7.0-68-g224e7625).
		static string get_version();

		/// Get the release Git tag version of smoothxg that the current version
		...
		/// Get a short one-line description of the current version of smoothxg with no terminating newline.
